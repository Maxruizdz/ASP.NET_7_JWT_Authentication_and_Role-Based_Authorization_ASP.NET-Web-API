...
namespace AspNet7JWT_Autentication.Controllers
{
    ...
    public class AuthController: ControllerBase
    {
        ...
        public async Task<IActionResult> SeedRoles() {
            ...
            if (isAdminRoleExist && isOwnerRoleExist && isUserRoleExist) {

                return Ok("Roles seeding is Alredy Done");
        ...
        {
        var isExistUser= await _userManager.FindByNameAsync(registerDtos.UserName);
            if (isExistUser is not null) {
                return BadRequest("Usename Alredy Exists");
            ...
            var CreateUserResult = await _userManager.CreateAsync(newUser, registerDtos.Password);
        ...
        public async Task<IActionResult> login([FromBody] LoginDtos loginDto) {
            ...
            if (user is null) { 
                return Unauthorized("Invalided Credentials");
            }
